...
<div class="hero-section section">
    ...
    <div class="hero-slider hero-slider-one">
        <!--Start Single Slider-->
        <div class="hero-slide-item d-flex image-bg align-items-center">
            <div class="container">
                <div class="row ">
                    <div class="col-lg-12 col-md-12">
                        <div class="hero-content-box">
                            <div class="hero-content text-center">
                                ...
                                <a href="Modules/Login.php" class="btn btn-large btn-circle">Get started!</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row d-flex justify-content-around">
                            <div class="col-4">
                                <div class="testimonal-img">
                                    <img class="testimonial-round-img" src="https://demo.hasthemes.com/togoo/assets/images/testimoniail/01.png" alt="testimonal image">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="testimonal-img">
                                    <img class="testimonial-round-img" src="https://demo.hasthemes.com/togoo/assets/images/testimoniail/02.png" alt="testimonal image">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="testimonal-img">
                                    <img class="testimonial-round-img" src="https://demo.hasthemes.com/togoo/assets/images/testimoniail/03.png" alt="testimonal image">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="testimonal-img">
                                    <img class="testimonial-round-img" src="https://demo.hasthemes.com/togoo/assets/images/testimoniail/04.png" alt="testimonal image">
                                </div>
                            </div>
                        </div>
