                    ...
                    <ul class="links d-flex align-items-center justify-content-center w-100 mt-3 mt-md-0">
                        ...
                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                            <a class="pt-1px  d-md-block" href="../Modules/Trips.php">
                                ...
                                <a class="pt-1px  d-md-block" href="../Modules/Trips.php"><span
                                        class="d-none d-md-inline">Trips</span> </a>
                        </li>
                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                            <a class="pt-1px  d-md-block" href="../Modules/Friends.php">
                                ...
                                <span class="d-none d-md-inline">Friends</span><span
                                    class="text-muted tx-12 d-none d-md-inline">4</span></a>
                        </li>
                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
